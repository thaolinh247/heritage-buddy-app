  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FDF3E7" }}>
      <View className="flex-1 px-5 pt-4 pb-4">
          ...
          {/* Title */}
          <Text
            className="text-center text-[#3E2723] mt-2"
            style={{ fontSize: 22, fontFamily: "OpenDyslexic-Bold" }}
          >
            Chọn chế độ hỗ trợ phù hợp
          </Text>

          {/* Selection Cards List */}
          <View className="flex-1 gap-2.5 mt-3">
            {CARDS.map((card) => {
          ...
          <Pressable
            ...
            className="w-full py-4 rounded-2xl mt-4 active:opacity-80"
            style={{
